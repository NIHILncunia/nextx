...
export default {
  lang: "en", // 'ko' | 'en' | 'jp'
  useSrc: false, // Whether to use src directory (default: false)
  componentInRoute: true, // Create components inside route (default: true)
  componentCategory: false, // Categorize shared components by group (default: false)
  aliases: {
    app: "app",
...
- `componentInRoute`: Whether to create components inside route. Default: `true`.
- `componentCategory`: Whether to categorize shared components by group. Default: `false`.
...
- `aliases.components`: Specifies the path to shared components directory. Default: `"components"`.
